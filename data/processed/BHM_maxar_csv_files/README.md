Example csv files generated by the data processing pipeline, i.e. by running the Python script `regrid_maxar.py` in `src/data`. The csv files contain the following columns:
